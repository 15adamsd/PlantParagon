...
<fieldset>
    <legend><h4>Please fill out all the spaces</h4></legend>
    <form action="updateProd_LP2.php" method="post">
    ...
    Product Name <input type="text" name="pname" value="<?php echo $row['prod_name']?>">
        ...
        <br>
        <br>
        Discount Code <input type="text" name="discount" value="<?php echo $row['prod_discount_code']; ?>">
        <br>
        <br>
</fieldset> 
<br>
<input style="font-size: 20px; margin-left: 60px;" type="submit" value="Submit">
</fieldset> 
</form>
</body>
<?
